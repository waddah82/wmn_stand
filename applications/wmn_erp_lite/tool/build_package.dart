...
void main() {
  ...
  final envelope = <String, Object?>{
    ...
    'generated_by': 'WMN ERP Lite editable application source',
    'platform_version': '3.24.0+126',
    'schema_version': 36,
...
Directory _locateAppRoot() {
  ...
  for (var depth = 0; depth < 8; depth++) {
    final candidate = Directory('${current.path}/applications/wmn_erp_lite');
  ...
  if (File('${candidate.path}/manifest.json').existsSync()) return candidate;
  throw StateError('Cannot locate applications/wmn_erp_lite from the current directory.');
}
