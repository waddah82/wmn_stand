...
/// R3.21 Application Generator & Packaging foundation.
///
/// Applications remain metadata-owned packages above WMN System Platform.
/// Build profiles describe how an application package is generated; build
/// records are immutable audit metadata for generated/imported standard application ZIP files.
class Migration036ApplicationGeneratorPackaging extends SqlDatabaseMigration {
  const Migration036ApplicationGeneratorPackaging();

  @override
  int get version => 36;

  @override
  String get name => 'application_generator_packaging';
