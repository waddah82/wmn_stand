...
/// Clean WMN Application Platform baseline.
///
/// This schema contains system/platform capabilities only. Business applications
/// such as POS, accounting, sales, purchase and stock are intentionally absent.
class Migration001PlatformBaseline extends SqlDatabaseMigration {
  const Migration001PlatformBaseline();

  @override
  int get version => 1;

  @override
  String get name => 'platform_baseline';
